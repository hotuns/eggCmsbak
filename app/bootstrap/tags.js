...
global.HeaderExtension = function () {
    ...
    this.run = function (context, args, bodyCallback) {
        ...
        // swiper
        metaArr.push(`<link rel="stylesheet" href="${_ctx.staticRootPath}/plugins/swiper/4.5.3/swiper.min.css">`);
        metaArr.push(`<script src="${_ctx.staticRootPath}/plugins/swiper/4.5.3/swiper.js?"></script>`);
